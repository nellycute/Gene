...
export const LEVEL: Level[] = [
  ...
  },
  {
    ...
    tingkat: "Dasar",
    isi: [
      { nomor: "1.1", judul: "Bukti bahwa DNA materi genetik" },
      { nomor: "1.2", judul: "Struktur DNA dan heliks ganda" },
      { nomor: "1.3", judul: "RNA dan bedanya dengan DNA" },
      { nomor: "1.4", judul: "Replikasi DNA" },
      { nomor: "1.5", judul: "Transkripsi: dari DNA ke RNA" },
      { nomor: "1.6", judul: "Kode genetik dan translasi" },
      { nomor: "1.7", judul: "Dari gen ke sifat" },
    ],
  },
  {
    nomor: 2,
    ...
    tingkat: "Dasar",
    isi: [
      { nomor: "2.1", judul: "Mendel, kacang ercis, dan istilah dasar" },
      { nomor: "2.2", judul: "Monohibrid dan Hukum Mendel I" },
      { nomor: "2.3", judul: "Diagram Punnett dan hukum peluang" },
      { nomor: "2.4", judul: "Uji silang dan silang balik" },
      { nomor: "2.5", judul: "Dihibrid dan Hukum Mendel II" },
      { nomor: "2.6", judul: "Trihibrid dan rumus cepat" },
    ],
  },
  {
    nomor: 3,
    ...
    tingkat: "Menengah",
    isi: [
      { nomor: "3.1", judul: "Dominansi tidak sempurna dan kodominansi" },
      { nomor: "3.2", judul: "Alel ganda: golongan darah ABO" },
      { nomor: "3.3", judul: "Alel letal" },
      { nomor: "3.4", judul: "Interaksi gen: bentuk jengger ayam" },
      { nomor: "3.5", judul: "Epistasis, hipostasis, dan kriptomeri" },
      { nomor: "3.6", judul: "Polimeri dan sifat poligenik" },
      { nomor: "3.7", judul: "Menebak interaksi dari rasionya" },
    ],
  },
  {
    nomor: 4,
    ...
    tingkat: "Menengah",
    isi: [
      { nomor: "4.1", judul: "Penentuan jenis kelamin" },
      { nomor: "4.2", judul: "Sifat terpaut kromosom kelamin" },
      { nomor: "4.3", judul: "Sifat dipengaruhi dan dibatasi kelamin" },
      { nomor: "4.4", judul: "Pautan gen" },
      { nomor: "4.5", judul: "Pindah silang dan rekombinasi" },
      { nomor: "4.6", judul: "Peta kromosom" },
      { nomor: "4.7", judul: "Membaca silsilah keluarga" },
    ],
  },
  {
    nomor: 5,
    ...
    tingkat: "Menengah",
    isi: [
      { nomor: "5.1", judul: "Mutasi gen: jenis dan akibatnya" },
      { nomor: "5.2", judul: "Perbaikan DNA" },
      { nomor: "5.3", judul: "Aneuploidi dan gagal berpisah" },
      { nomor: "5.4", judul: "Poliploidi" },
      { nomor: "5.5", judul: "Perubahan struktur kromosom" },
      { nomor: "5.6", judul: "Penyakit genetik pada manusia dan ternak" },
    ],
  },
  {
    nomor: 6,
    ...
    tingkat: "Lanjut",
    isi: [
      { nomor: "6.1", judul: "Frekuensi alel dan Hardy-Weinberg" },
      { nomor: "6.2", judul: "Empat pengubah frekuensi alel" },
      { nomor: "6.3", judul: "Sifat kuantitatif dan heritabilitas" },
      { nomor: "6.4", judul: "Genetika dalam pemuliaan" },
      { nomor: "6.5", judul: "Isolasi DNA, PCR, dan elektroforesis" },
      { nomor: "6.6", judul: "Sekuensing dan penanda genetik" },
      { nomor: "6.7", judul: "DNA dalam forensik dan keseharian" },
    ],
  },
];
