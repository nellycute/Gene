import type { Pelajaran, Tingkat } from "./tipe";
 ...
 * Dipakai halaman depan agar penonton melihat ke mana materi ini menuju,
 * bukan cuma yang sudah jadi. Rinciannya ada di KURIKULUM.md.
 * ------------------------------------------------------------------ */
...
export const LEVEL: Level[] = [
  {
    ...
    nama: "Fondasi Sel",
    ringkas:
      "Di mana materi genetik itu berada secara fisik, sebelum kita belajar bagaimana ia bekerja.",
    tingkat: "Dasar",
    isi: [
  ...
  },
  {
    ...
    nama: "Dogma Sentral",
    ringkas:
      "Perjalanan lengkap dari DNA menjadi RNA, lalu menjadi protein yang bekerja.",
    tingkat: "Dasar",
    isi: [
  ...
  },
  {
    ...
    ringkas:
      "Apa isi tiga miliar pasang basa manusia, dan bagaimana sel memutuskan gen mana yang dinyalakan.",
    tingkat: "Menengah",
    isi: [
  ...
  },
  {
    ...
    ringkas: "Bagaimana perbedaan muncul, dan bagaimana ia berpindah antar generasi.",
    tingkat: "Menengah",
    isi: [
  ...
  },
  {
    ...
    ringkas:
      "Dari tabung sampai mesin sequencing — bagian yang paling langka penjelasannya dalam bahasa Indonesia.",
    tingkat: "Lanjut",
    isi: [
  ...
  },
  {
    ...
    ringkas: "Apa yang terjadi pada data setelah mesin sequencing selesai bekerja.",
    tingkat: "Lanjut",
    isi: [
